...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--Quality_restore", default=True,action="store_true", help="For RGB images")
        self.parser.add_argument(
            "--Scratch_and_Quality_restore", action="store_true",default=False, help="For scratched images"
        )
